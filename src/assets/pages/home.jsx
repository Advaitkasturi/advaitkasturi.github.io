...
import AdvaitImage from "../pictures/AdvaitK.jpg"; // Adjust path if needed
...
<p className="text-center text-gray-700 text-sm sm:text-lg leading-relaxed max-w-xl mx-auto mb-5 px-1 sm:px-0">
  Exploring the potential of <span className="text-[#06b6d4] font-semibold">Artificial Intelligence</span> and <span className="text-[#06b6d4] font-semibold">Machine Learning</span> to solve real-world problems.  
  I blend smart algorithms with intuitive design to build intelligent, user-focused web and mobile experiences.
</p>
